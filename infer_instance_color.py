...
args = dict(
    ...
    save=True,
    save_dir='/media/a104/D/stli/erfnet/save/instance_training/infer_color/',
...
with torch.no_grad():
    ...
    for sample in tqdm(dataset_it):
        ...
        if args['save']:
            ...
            instances = Colorize()(instances.unsqueeze(0))
            im = torchvision.transforms.ToPILImage()(instances)
