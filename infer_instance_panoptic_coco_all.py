...
dat = []
for line in open("/media/a104/D/stli/erfnet/train/cfg/train_coco.txt","r"):
    dat.append(line.strip('\n'))

for i in range(len(dat)):
    im = cv2.imread("/media/a104/D/stli/erfnet/train/data/coco/images/val2017/"+dat[i]+".jpg")
...
#第一个
    segmentation_result.save("/media/a104/D/stli/erfnet/save/instance_training/infer/"+dat[i]+".png")
#第二个
    #segmentation_result.save("/media/a104/D/stli/erfnet/save/panoptic_training/infer/"+dat[i]+".png")
