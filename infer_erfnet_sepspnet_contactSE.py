...
from erfnet_sepspnet_contactSE import Net
from post_processing.transform import Relabel, ToLabel, Colorize
...
def main(args):
    ...
    for step, (images, labels, filename, filenameGt) in enumerate(loader):
        ...
        filenameSave = "../save/erfnet_training_sepspnet_contactSE/infer_color/" + filename[0].split("leftImg8bit/")[1]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--loadDir',default="../save/erfnet_training_sepspnet_contactSE/")
    parser.add_argument('--loadWeights', default="model_best.pth")
    parser.add_argument('--loadModel', default="erfnet_sepspnet_contactSE.py")
    parser.add_argument('--subset', default="val")  #can be val, test, train, demoSequence

    parser.add_argument('--datadir', default="/media/a104/D/stli/data/cityscapes/")
