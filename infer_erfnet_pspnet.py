...
def main(args):
    ...
    for step, (images, labels, filename, filenameGt) in enumerate(loader):
        ...
        filenameSave = "../save/erfnet_training2_pspnet_all/infer_color/" + filename[0].split("leftImg8bit/")[1]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--loadDir',default="../save/erfnet_training2_pspnet_all/")
    parser.add_argument('--loadWeights', default="model_best.pth")
    parser.add_argument('--loadModel', default="erfnet_pspnet.py")
